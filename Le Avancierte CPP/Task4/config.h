 ...
 */
//#define SRCFILE ("Task4/Images/olle.png")
//#define DESTFILE ("Task4/Images/olleOutput.png")

#define SRCFILE ("Task4/Images/tronlegacy.png")
#define DESTFILE ("Task4/Images/tronLegacyOutput.png")
