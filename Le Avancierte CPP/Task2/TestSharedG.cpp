...
void TestG() {
    ...
    //	o	En SharedPtr	G
    {
        ...
        FinishedTest("assignment and move assignment");
    }
    {
    ...
    //get, * och ->
    {
        ...
        FinishedTest("get and derefferencing");
        //move
